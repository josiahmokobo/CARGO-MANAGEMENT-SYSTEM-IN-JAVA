...
public class recover  extends JFrame{
	...
	JLabel date =new JLabel("ENTER EMPLOYEE NO.");
	JLabel msg1 =new JLabel("return message:".toUpperCase());
	JTextField Tdate =new JTextField(12);
	...
	public recover()
		...
		label.setFont(new Font("Gabriola",1,20));
		Ttype.setBackground(Color.YELLOW);
		  label.setForeground(new Color(255, 0, 0));
		   label.setBounds(new Rectangle(100,0,440,95));
		 ...
		 type.setBounds(new Rectangle(400,90,150,30));
		 Ttype.setBounds(new Rectangle(530,90,150,30));
		...
		date.setBounds(new Rectangle(400,130,150,30));
		Tdate.setBounds(new Rectangle(530,130,150,30));
